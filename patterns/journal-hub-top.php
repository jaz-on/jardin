...
<div class="wp-block-group journal-hub-block">
	...
	<p class="has-text-muted-color has-text-color has-sm-font-size"><?php echo esc_html__( 'A mixed timeline of long posts, notes, likes, bookmarks, events, beer reviews, music jams, and TIL—newest first. Raw scrobbles and tastings without notes stay in their own views; use the filters to narrow by type.', 'jardin' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-group feed-header">
		<!-- wp:heading {"level":2} -->
		<h2 class="wp-block-heading"><?php esc_html_e( 'Filtrer le journal', 'jardin' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
