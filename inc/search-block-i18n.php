...
function jardin_i18n_search_block_data( array $parsed_block ): array {
	...
	$parsed_block['attrs']['label']       = __( 'Search', 'jardin-theme' );
	$parsed_block['attrs']['placeholder'] = __( 'Search…', 'jardin-theme' );
	$parsed_block['attrs']['buttonText']  = __( 'Search', 'jardin-theme' );
	return $parsed_block;
}
