...
/**
 * Theme palette toggle markup (used by `jardin-theme/theme-toggle` and `jardin-theme/header-utilities`).
 *
 * @return string
 */
function jardin_get_theme_toggle_markup(): string {
	...
	<details class="jardin-theme-toggle wp-block-jardin-theme-theme-toggle">
		<summary class="jardin-theme-toggle__summary" aria-label="<?php echo esc_attr__( 'Change color theme', 'jardin-theme' ); ?>">
			<svg class="jardin-theme-toggle__icon" width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
				<path fill="currentColor" d="M12 3a9 9 0 1 0 9 9c0-.46-.04-.92-.1-1.36a5.5 5.5 0 0 1-4.31-4.3A9 9 0 0 0 12 3m0 2c3.87 0 7 3.13 7 7 0 .39-.03.77-.1 1.14a3.5 3.5 0 0 0-2.73-2.73A7 7 0 0 0 12 5m-5 9a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3m3-5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3m5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3m3 5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3"/>
			</svg>
		</summary>
...
|--------------------------------------------------------------------------
| Custom rewrite *rules* for CPTs belong in plugins or core registration;
| the theme still flushes the rules table when the theme package changes so
| new routes from plugins stay resolvable without a manual Permalinks save.
*/
...
/**
 * Latest mtime among sentinel theme files.
 */
