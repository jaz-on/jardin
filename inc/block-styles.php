...
function jardin_register_block_styles(): void {
	$definitions = array(
		...
		array( 'core/paragraph', 'text-meta-sm', __( 'Meta text small', 'jardin' ) ),
		array( 'core/paragraph', 'text-meta-base', __( 'Meta text base', 'jardin' ) ),
		array( 'core/heading', 'mono-label', __( 'Mono label', 'jardin' ) ),
		array( 'core/heading', 'stat-label', __( 'Stat label', 'jardin' ) ),
		array( 'core/list', 'bare', __( 'Bare list', 'jardin' ) ),
		array( 'core/list', 'inline', __( 'Inline list', 'jardin' ) ),
		array( 'core/list', 'none', __( 'No bullets', 'jardin' ) ),
		array( 'core/list-item', 'bullet-row', __( 'Bullet row', 'jardin' ) ),
		array( 'core/list-item', 'bullet-row-solid', __( 'Bullet row solid', 'jardin' ) ),
		array( 'core/quote', 'pull-quote', __( 'Pull quote', 'jardin' ) ),
		array( 'core/quote', 'quote-card', __( 'Quote card', 'jardin' ) ),
		...
		array( 'core/image', 'icon-inline', __( 'Inline icon', 'jardin' ) ),
		...
		array( 'core/group', 'callout-pad-sm', __( 'Callout compact', 'jardin' ) ),
		...
		array( 'core/group', 'avatar-circle', __( 'Avatar circle', 'jardin' ) ),
		array( 'core/group', 'caption', __( 'Caption', 'jardin' ) ),
		array( 'core/group', 'mb-stat', __( 'Microblog stat', 'jardin' ) ),
